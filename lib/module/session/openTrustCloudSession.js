...
export function openTrustCloudSession(options) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (!presented) {
      reject(makeError('PORTAL_NOT_MOUNTED', "Render <TrustCloudPortal /> once at your app root to use openTrustCloudSession with mode 'webview'"));
    }
  });
}
