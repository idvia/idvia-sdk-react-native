...
exports.useTrustCloudSession = useTrustCloudSession;
var _react = require("react");
var _openTrustCloudSession = require("./openTrustCloudSession");
function useTrustCloudSession() {
  ...
  const present = (0, _react.useCallback)(async options => {
    ...
    setError(null);
    try {
      const sessionResult = await (0, _openTrustCloudSession.openTrustCloudSession)(options);
