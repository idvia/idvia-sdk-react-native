...
exports.openIdviaSession = openIdviaSession;
...
function openIdviaSession(options) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (!presented) {
      reject((0, _types.makeError)('PORTAL_NOT_MOUNTED', "Render <IdviaPortal /> once at your app root to use openIdviaSession with mode 'webview'"));
    }
  });
}
