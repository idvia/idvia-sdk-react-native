...
const VideoIdUnassistedSession = exports.VideoIdUnassistedSession = _TrustCloudSession.TrustCloudSession;

/** VideoID Assisted — live agent call. Prefer openTrustCloudSession in-app-browser mode. */
const VideoIdAssistedSession = exports.VideoIdAssistedSession = _TrustCloudSession.TrustCloudSession;

/** Sign — no camera/mic needed, so media permissions default off. */
function SignSession(props) {
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_TrustCloudSession.TrustCloudSession, {
